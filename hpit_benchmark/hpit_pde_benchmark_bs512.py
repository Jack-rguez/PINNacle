...
RESULTS_CSV = RESULTS_DIR / "hpit_results_bs512.csv"
...
def benchmark_pde(pde_name: str, args, device: str):
    ...
    try:
        ...
        if args.checkpoint and os.path.exists(args.checkpoint):
            ...
            ckpt_path = RESULTS_DIR / f"hpit_{pde_name}_bs512.pt"
...
def main():
    ...
    parser.add_argument("--patience", type=int, default=50,
                        help="Early-stopping patience: halt after this many epochs with no loss improvement (default: 50)")
    ...
    parser.add_argument("--lr", type=float, default=2e-3,
                        help="Learning rate (default: 2e-3, sqrt-scaled for bs=512)")
